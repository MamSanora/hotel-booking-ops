...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\xampp\\htdocs\\Project_Sarana\\Hotel_Booking_Ops\\public\\storage','fortify.guard',
...
'livewire.preview-file','home','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.body','admin.create_room','admin.css','admin.footer','admin.header',
'admin.index','admin.sidebar','admin.update_room','admin.view_room','api.api-token-manager',
'api.index','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.two-factor-challenge','auth.verify-email','components.action-message','components.action-section',
'components.admin-user-menu','components.application-logo','components.application-mark','components.authentication-card','components.authentication-card-logo',
...
'components.validation-errors','components.welcome','dashboard','emails.team-invitation','home.about',
'home.banner','home.blog','home.contact','home.css','home.footer',
'home.gallery','home.header','home.index','home.room','home.room_details',
'home.slider','layouts.app','layouts.guest','navigation-menu','policy',
...
'D:.xampp.htdocs.Project_Sarana.Hotel_Booking_Ops.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
