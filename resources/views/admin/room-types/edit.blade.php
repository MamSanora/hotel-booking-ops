            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 mt-2">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <div class="relative">
                            <input type="checkbox" name="is_visible" value="1" class="peer sr-only" {{ old('is_visible', $roomType->is_visible) ? 'checked' : '' }}>
                ...
                <div class="md:col-span-2 mt-2">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <div class="relative">
                            <input type="checkbox" name="use_mam_sanora_qr" value="1" class="peer sr-only" {{ old('use_mam_sanora_qr', $roomType->use_mam_sanora_qr) ? 'checked' : '' }}>
                            <div class="block h-6 w-10 rounded-full bg-gray-300 transition peer-checked:bg-hotel-gold"></div>
                            <div class="dot absolute left-1 top-1 h-4 w-4 rounded-full bg-white transition peer-checked:translate-x-4"></div>
                        </div>
                        <div class="text-[0.95rem] font-medium text-gray-700">
