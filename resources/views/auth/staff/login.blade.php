...
<head>
    ...
    <title>Staff Login — Dara Meas Hotel</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@600;700&family=Inter:wght@300;400;500;600&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
</head>
<body class="min-h-screen bg-hotel-accent font-[Inter]">

<div class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">

        {{-- Card --}}
        <div class="bg-white rounded-[20px] shadow-[0_24px_60px_rgba(0,0,0,0.25)] p-8 md:p-10">

            {{-- Header --}}
            <div class="text-center mb-8">
                <div class="w-16 h-16 bg-gradient-to-br from-hotel-accent to-[#0f3460] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
            ...
            <form method="POST" action="{{ route('reception.login.post') }}" class="space-y-5">
                ...
                {{-- Submit --}}
                <button type="submit"
                        class="w-full bg-hotel-accent hover:bg-hotel-dark text-white font-semibold rounded-xl py-3.5 transition-all duration-300 hover:shadow-lg flex items-center justify-center gap-2 mt-2">
                    <i class="bi bi-box-arrow-in-right"></i> Sign In as Staff
                </button>
            </form>
            ...
            <div class="mt-6 pt-6 border-t border-gray-100 flex justify-between text-xs text-gray-400">
                ...
                <a href="{{ route('admin.login') }}" class="hover:text-hotel-dark transition-colors flex items-center gap-1">
