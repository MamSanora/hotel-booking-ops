                    ...
                    @if($booking->bookingRooms->count() > 0)
                        @foreach($booking->bookingRooms as $bRoom)
                            <tr class="border-b border-gray-100">
                                ...
                                <td class="py-5 px-4 text-center">Rm {{ in_array($booking->booking_status, ['checked_in', 'checked_out', 'completed']) ? ($bRoom->room?->room_number ?? 'TBA') : 'TBA' }} × {{ $booking->nightCount() }} night(s)</td>
