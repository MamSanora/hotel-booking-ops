    ...
    <div class="max-w-5xl w-full mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-7">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <!-- <h1 class="text-lg font-bold text-gray-900 leading-snug">Complete Payment &mdash; Bakong Open API</h1> -->
                    <h1 class="text-lg font-bold text-gray-900 leading-snug">Complete Payment &mdash; KHQR</h1>
            ...
            <div class="lg:col-span-5 flex flex-col items-center">
                ...
                <div class="w-full max-w-[340px] rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.12)]">
                    <div class="relative" style="width: 106%; margin-left: -3%; margin-top: -3%; margin-bottom: -3%;">
                        ...
                        <div class="absolute bg-white flex items-center justify-center rounded-md" style="top: 14%; left: 7%; right: 7.3%; height: 10%;">
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        new QRCode(document.getElementById('khqr-matrix'), {
                            text: @json($khqrData['khqr_string']),
