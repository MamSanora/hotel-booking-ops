    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div class="order-1 lg:order-2">
            ...
            <p class="text-gray-600 leading-relaxed mb-5 text-[1.05rem]">
                Established in 2019 in the heart of Phnom Penh, Cambodia, Dara Meas Hotel is a 2.5-star boutique property offering warm Cambodian hospitality, modern comfort, and executive convenience across 4 floors and 47 carefully crafted guest rooms.
            </p>
